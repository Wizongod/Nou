function NN = ConstructNN(nodes_in,nodes_out,hidden_struct,activation_function,d_activation_function)
...
NN.afunc = activation_function;
NN.dafunc = d_activation_function;
...
NN.w = normrnd(0,1,max(NN.structure),max(NN.structure),NN.layers-1); % weight matrix
